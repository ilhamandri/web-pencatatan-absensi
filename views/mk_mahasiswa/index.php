              	...
              	<div class="card">
		            ...
		            <!-- Table -->
		            	<table class="table">
			              	...
			              	<tbody>
			              		<?php
									$sql = "SELECT mk_mahasiswa.id as id, mahasiswa.id AS mahasiswa_id, matakuliah.id AS mk_id, mahasiswa.npm, mahasiswa.nama FROM mahasiswa JOIN mk_mahasiswa ON mk_mahasiswa.mahasiswa_id = mahasiswa.id JOIN matakuliah ON matakuliah.id = mk_mahasiswa.matakuliah_id WHERE matakuliah.id = ".$matakuliah_id;
									$result = mysqli_query($conn, $sql);
